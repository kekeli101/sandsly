...
export const fallbackCatalog = {
  ...
  products: [
    ...
    { id: "spicy-honey-pepperoni", name: "Spicy Honey Pepperoni", description: "Thick crust, charred cups, and our signature hot honey drizzle.", pricePesewas: 14000, imageUrl: "https://images.unsplash.com/photo-1579751626657-72bc17010498?auto=format&fit=crop&w=1400&q=85", badge: "Hot", crunchLevel: 3, categorySlug: "pizza", categoryName: "Pizza", sortOrder: 1 },
