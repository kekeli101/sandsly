...
function Router() { return <Switch><Route path="/admin" component={AdminDashboard} /><Route path="/kitchen" component={KitchenDashboard} /><Route component={StorefrontRouter} /></Switch>; }
